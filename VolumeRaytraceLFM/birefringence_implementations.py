...
class BirefringentRaytraceLFM(RayTraceLFM, BirefringentElement):
    ...
    def ray_trace_through_volume(self, volume_in : BirefringentVolume = None, precompute=True):
        ...
        if self.backend == BackEnds.PYTORCH and precompute:
    ...
    def calc_cummulative_JM_of_ray_torch2(self, volume_in : BirefringentVolume, micro_lens_offset=[0,0]):
    ...
    def calc_cummulative_JM_of_ray_torch(self, volume_in : BirefringentVolume, micro_lens_offset=[0,0], precompute=False):
        '''This function computes the Jones Matrices of all rays defined in this object.
            It uses pytorch's batch dimension to store each ray, and process them in parallel'''
        ...
        if key not in self.vox_indices_ml_shifted.keys():
            ...
            self.vox_indices_ml_shifted_all += self.vox_indices_ml_shifted[key]
    ...
    def ret_and_azim_images_mla_torch(self, volume_in : BirefringentVolume):
        ...
        effective_JM = self.calc_cummulative_JM_of_ray_torch2(volume_in)
