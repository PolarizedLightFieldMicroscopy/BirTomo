...
plane_args = {"init_mode": "1planes", "init_args": {}}
...
voxel_shifted_args = {
    "init_mode": "single_voxel",
    "init_args": {"delta_n": 0.05, "offset": [1, 0, 0]},
}

voxel_shiftedy_args = {
    "init_mode": "single_voxel",
    "init_args": {"delta_n": 0.05, "offset": [0, 1, 0]},
}

voxel_shiftedyz_args = {
    "init_mode": "single_voxel",
    "init_args": {"delta_n": 0.05, "offset": [0, 1, 1]},
}
...
random_args = {
    "init_mode": "random",
    "init_args": {"Delta_n_range": [0, 0.02], "axes_range": [-1, 1]},
}

random_neg_args = {
    "init_mode": "random",
    "init_args": {"Delta_n_range": [-0.02, 0], "axes_range": [-1, 1]},
}

random_all_args1 = {
    "init_mode": "random",
    "init_args": {"Delta_n_range": [-0.01, 0.01], "axes_range": [-1, 1]},
}
...
random_args8 = {
    "init_mode": "random",
    "init_args": {"Delta_n_range": [0, 0.008], "axes_range": [-1, 1]},
}
