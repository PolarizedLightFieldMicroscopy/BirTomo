...
optical_config_file = os.path.join("..", "config", "Starch", "optical_config.json")
iter_config_file = os.path.join("..", "config", "Starch", "iter_config.json")

# Path to the directory where the reconstruction will be saved
recon_output_dir = os.path.join("..", "reconstructions", "Starch")

# Whether to continue a previous reconstruction or start from a given volume
continue_recon = True
recon_init_file_path = os.path.join(r"../data/2025_10/Starch/Simulation Data/StarchCropInitRand1.h5")
# recon_init_file_path = os.path.join(r"../reconstructions/Starch/2025-10-29_12-32-27/volume.h5")
# For loading forward images that were saved in a previous reconstruction folder

measurement_dir = os.path.join(r"../data/2025_10/Starch/Experimental Data")
...
if simulate:
    ...
    ret_image_meas_tiff = imread(os.path.join(measurement_dir, "Starch1246Slice6CropARectRet32bit.tif"))
    ret_image_meas = np.array(ret_image_meas_tiff)
    azim_image_meas_tiff = imread(os.path.join(measurement_dir, "Starch1246Slice6CropARectAzim32bit.tif"))
