...
optical_info = setup_optical_parameters(r"../config/Xylem/optical_config.json")
...
volume_file_path = r"../reconstructions/Xylem/2026-02-27_08-50-00_Mac_SMS1308Sl49Crop1Ss1Ar8RcSs1It100/volume.h5"
...
save_dir = r"../reconstructions/Xylem/2026-02-27_08-50-00_Mac_SMS1308Sl49Crop1Ss1Ar8RcSs1It100"
save_as_tif(os.path.join(save_dir, "RetardanceLFPredicted.tif"),
            simulator.ret_img.detach().cpu().numpy(),
            {"Optical info": optical_info}
            )
save_as_tif(os.path.join(save_dir, "OrientationLFPredicted.tif"),
