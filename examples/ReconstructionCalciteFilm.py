...
optical_config_file = os.path.join("..", "config", "CalciteFilm", "optical_config.json")
iter_config_file = os.path.join("..", "config", "CalciteFilm", "iter_config.json")

# Path to the directory where the reconstruction will be saved
recon_output_dir = os.path.join("..", "reconstructions", "CalciteFilm")

# Whether to continue a previous reconstruction or start from a given volume
# if continue_recon = False, it seems to generate its own random data
continue_recon = True
# recon_init_file_path = os.path.join(r"../reconstructions/CalciteFilm/2026-02-28_09-47-21_Mac_PS1723Crop1Ss1Ar75SingleZNeg∆nRcSs1It100/volume.h5")
recon_init_file_path = os.path.join(r"../data/2026_03/CalciteFilm/Simulation Data/PS_1723Crop1Ss1RandomAllF.h5")

# Path to experimental light field images or forward images that were saved in a previous reconstruction
measurement_dir = os.path.join(r"../data/2026_03/CalciteFilm/Experimental Data")
...
if simulate:
    ...
    ret_image_meas_tiff = imread(os.path.join(measurement_dir, "PS_1723Crop1_32bitRet.tif"))
    ret_image_meas = np.array(ret_image_meas_tiff)
    azim_image_meas_tiff = imread(os.path.join(measurement_dir, "PS_1723Crop1_32bitAzim.tif"))
...
# %% 
# Save measured images as TIF
# For saving simulated light field images of a reconstructed volume, use SimulationXylem.py
save_dir = r"../data/2026_02/XylemB/Simulation Data"
