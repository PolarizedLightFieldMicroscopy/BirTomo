...
optical_info = setup_optical_parameters(r"../config/ClamShell/optical_config.json")
...
volume_file_path = r"../data/2025_09/ClamShell/Simulation Data/ClamShellCrop1InitRand1.h5"
