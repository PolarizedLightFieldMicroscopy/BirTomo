...
optical_config_file = os.path.join("..", "config", "ClamShell", "optical_config.json")
iter_config_file = os.path.join("..", "config", "ClamShell", "iter_config.json")

# Path to the directory where the reconstruction will be saved
recon_output_dir = os.path.join("..", "reconstructions", "ClamShell")

# Whether to continue a previous reconstruction or start from a given volume
continue_recon = True
recon_init_file_path = os.path.join(r"../data/2025_09/ClamShell/Simulation Data/ClamShellCrop1InitRand1.h5")
# recon_init_file_path = os.path.join(r"../reconstructions/ClamShell/2025-07-11_01-41-13_Mac_L2_100Crop2Ss1RandIt200/volume.h5")
# For loading forward images that were saved in a previous reconstruction folder

measurement_dir = os.path.join(r"../data/2025_09/ClamShell/Experimental Data")
...
if simulate:
    ...
    ret_image_meas_tiff = imread(os.path.join(measurement_dir, "ClamShell1015Slice9RectCrop1Ret32bit.tif"))
    ret_image_meas = np.array(ret_image_meas_tiff)
    azim_image_meas_tiff = imread(os.path.join(measurement_dir, "ClamShell1015Slice9RectCrop1Azim32bit.tif"))
