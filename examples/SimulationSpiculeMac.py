...
optical_info = setup_optical_parameters("/Users/rudolfo/Software/GitHub/BirTomo/config/optical_config_spicule.json")
...
save_dir = "/Users/rudolfo/Software/GitHub/BirTomo/data/2025_04/SpiculeA Experim&Simulation/Simulation Data/LF Images BirTomo"
save_as_tif(os.path.join(save_dir, "Spicule1248April9_RevX-h5_April9BirTomoLFRet.tif"),
            simulator.ret_img.detach().cpu().numpy(),
            {"Optical info": optical_info}
            )
save_as_tif(os.path.join(save_dir, "Spicule1248April9_RevX-h5_April9BirTomoLFAzim.tif"),
