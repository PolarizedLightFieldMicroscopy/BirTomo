...
continue_recon = True
# recon_init_file_path = os.path.join(r"../reconstructions/Xylem/2026-02-18_08-34-12_Mac_Crop1Ss1RandIt100/volume.h5")
recon_init_file_path = os.path.join(r"../data/2026_02/XylemB/Simulation Data/XylemB1307Crop3Ss3ReconSs1Iter200.h5")

# For loading forward images that were saved in a previous reconstruction folder
measurement_dir = os.path.join(r"../data/2026_02/XylemB/Experimental Data")
...
if simulate:
    ...
    ret_image_meas_tiff = imread(os.path.join(measurement_dir, "XylemB1307Crop3_32bitRet.tif"))
    ret_image_meas = np.array(ret_image_meas_tiff)
    azim_image_meas_tiff = imread(os.path.join(measurement_dir, "XylemB1307Crop3_32bitAzim.tif"))
