...
optical_config_file = os.path.join("..", "config", "Voxels", "optical_config.json")
iter_config_file = os.path.join("..", "config", "Voxels", "iter_config.json")

# Path to the directory where the reconstruction will be saved
recon_output_dir = os.path.join("..", "reconstructions", "Voxels","2025-09-03")

# Whether to continue a previous reconstruction or start from a given volume
continue_recon = True
recon_init_file_path = os.path.join(r"../data/2025_09/Voxels/Simulation Data/VoxelsInitRandom1.h5")

# Directory for loading forward images
measurement_dir = os.path.join(r"../data/2025_09/Voxels/Simulation Data/LF Images BirTomo")
...
if simulate:
    ...
    volume_GT_path = os.path.join(r"../data/2025_09/Voxels/Simulation Data/VoxelRingXYoAZ.h5")
    volume_GT = BirefringentVolume.init_from_file(volume_GT_path, BACKEND, optical_info)
   # volume_GT = None
