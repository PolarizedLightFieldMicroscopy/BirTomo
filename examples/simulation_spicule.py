...
save_dir = r"C:\Users\OldenbourgLab2\Code\forward-model\data\2025_02\Spicule Experim&Simulation\SpiculeA\Simulation Data\LF Images forward model"
save_as_tif(os.path.join(save_dir, "Spicule1248Feb17-h5_Feb17ForwModLFRet.tif"),
            simulator.ret_img.detach().cpu().numpy(),
            {"Optical info": optical_info}
            )
save_as_tif(os.path.join(save_dir, "Spicule1248Feb17-h5_Feb17ForwModLFAzim.tif"),
