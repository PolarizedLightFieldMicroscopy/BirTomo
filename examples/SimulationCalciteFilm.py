...
optical_info = setup_optical_parameters(r"../config/CalciteFilm/optical_config.json")
...
volume_file_path = r"../reconstructions/CalciteFilm/2026-03-17_23-09-26_Mac_PS1723Crop1_PS1723Crop1RandAllF_OptInfC_ItDef50/volume.h5"
...
save_dir = r"../reconstructions/CalciteFilm/2026-03-17_23-09-26_Mac_PS1723Crop1_PS1723Crop1RandAllF_OptInfC_ItDef50"
save_as_tif(os.path.join(save_dir, "volumeH5_32bitRet.tif"),
            simulator.ret_img.detach().cpu().numpy(),
            {"Optical info": optical_info}
            )
save_as_tif(os.path.join(save_dir, "volumeH5_32bitAzim.tif"),
