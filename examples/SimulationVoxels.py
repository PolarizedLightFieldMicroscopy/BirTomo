...
optical_info = setup_optical_parameters(r"../config/Voxels/optical_config.json")
...
volume_file_path = r"../data/2025_04/Voxels/Simulation Data/OneVoxBirBot6OaZ_April27.h5"
...
save_as_tif(os.path.join(save_dir, 'OneVoxBirBot6OaZ_April27-h5_Apr27_60x12_Ret.tif'),
            simulator.ret_img.detach().cpu().numpy(),
            {"Optical info": optical_info}
            )
save_as_tif(os.path.join(save_dir, 'OneVoxBirBot6OaZ_April27-h5_Apr27_60x12_Azim.tif'),
