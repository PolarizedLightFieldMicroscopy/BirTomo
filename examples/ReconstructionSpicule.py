...
optical_config_file = os.path.join("..", "config", "Spicule", "optical_config.json")
iter_config_file = os.path.join("..", "config", "Spicule", "iter_config.json")

# Path to the directory where the reconstruction will be saved
recon_output_dir = os.path.join("..", "reconstructions", "Spicule")

# Whether to continue a previous reconstruction or start from a given volume
continue_recon = True
recon_init_file_path = os.path.join(r"../reconstructions/Spicule/2025-07-15_10-37-32_Mac_Ss1L2_100RevXRandIt100/volume.h5")
